          ...
          {decodeMode === 'function' ? (
            <>
              ...
              <div>
                ...
                <button
                  onClick={() => {
                    setAbiData('')
                    setSignature('')
                    setIsFunction(true)
                    setAutoDetect(true)
                  }}
              ...
              <div>
                <span className="font-medium">zkSync sendToL1:</span>
                <button
                  onClick={() => {
                    setAbiData('')
                    setSignature('')
                    setIsFunction(true)
                    setAutoDetect(true)
                  }}
                ...
                <div className="text-gray-600 dark:text-gray-400 mt-1">
                  <p>zkSync L2→L1 message with nested ERC20 transfer.</p>
                </div>
              </div>

              <div className="text-gray-600 dark:text-gray-400">
                <p>Enable &ldquo;Auto-lookup signature&rdquo; to automatically detect and decode Uniswap and zkSync transactions.</p>
              </div>
            </>
          ) : (
            <>
